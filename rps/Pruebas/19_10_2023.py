...
#tf_policy_saver.save(trained_premodel_path)
checkpoint_zip_filename = myenv_tf_agents.create_zip_file(trained_premodel_path, trained_premodel_path + 'exported_cp')
print(f"checkpoint zip file name : {checkpoint_zip_filename}")
...
saved_policy = tf.saved_model.load(trained_premodel_path)

#save trained agent into a video....
video_file_name = "tf-agents"

eager_py_policy = py_tf_eager_policy.SavedModelPyTFEagerPolicy(
    trained_premodel_path, eval_py_robotarium.time_step_spec(), eval_py_robotarium.action_spec())
x = eager_py_policy.get_initial_state()
y = eager_py_policy.action_spec
w = eager_py_policy.variables()
model = load_model(eager_py_policy)
#myenv_tf_agents.run_episodes_and_create_video(saved_policy,eval_tf_robotarium,eval_py_robotarium )
